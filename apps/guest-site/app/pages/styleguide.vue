...
<template>
  <div class="max-w-5xl mx-auto px-6 py-20 space-y-20">
    ...
    <section>
      ...
      <p class="text-primary-900 mb-10 max-w-3xl leading-relaxed">
        <span class="font-display">Outfit</span> on display — taglines, section titles, hero
        moments. Geometric humanist sans with generous counters and a confident tone at large sizes.
        Inter for body, UI, navigation — the workhorse that stays invisible. Both sit in the same
        family lineage so brand voice stays coherent.
      </p>

...
- **Slice B — Identify** in flight: B1 (cookie-based Supabase auth plumbing + `/api/me`) ✓. B2 (signup/login/logout UI + nav state + `/account`) next. B3 (password reset) after that.
- **Next action:** start B2.

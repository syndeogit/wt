...
- **Slice B — Identify** in flight: B1 (cookie-based Supabase auth plumbing + `/api/me`) ✓, B2 (signup/login/account pages + nav state + route-middleware auth) ✓. B3 (password reset) next.
- **Next action:** start B3.
